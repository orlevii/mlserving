...
from ganesha.app import GaneshaConfig
...
def generate_ganesha_config() -> GaneshaConfig:
    return GaneshaConfig(service_name='test_ganesha',
                         listen_port=1234)


def generate_ganesha_config_with_model() -> GaneshaConfig:
