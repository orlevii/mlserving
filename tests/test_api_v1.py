...
from mest.app.api import generate_api_v1, generate_models_health_check, InvalidHealthCheck
from tests.common import generate_mest_config_with_model, MyTestModel


class MestCoreApiV1Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = self.mest.app.test_client()
    ...
    def test_pre_made_api_ping(self):
        ...
        expected_text = 'Pong from {}!'.format(self.mest.config.service_name)
    ...
    def test_pre_made_api_health_with_error(self):
        ...
        self.mest.config.health_check_methods = dict(model=self.failing_method)
        res = self.client.get('/api/v1/health')
    ...
    def test_pre_made_api_health_with_model_check(self):
        ...
        self.mest.config.models_instances = models_instances
        self.mest.config.health_check_methods = generate_models_health_check(models_instances)
